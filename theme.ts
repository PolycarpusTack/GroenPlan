...
export const gpMotion = {
  ...
  durBase: 180,
  durSlow: 240,
  ease: [0.22, 0.61, 0.36, 1] as const,        // cubic-bezier args
...
// ────────────────────────────────────────────────────────────────────
// Helpers for domain-specific styling
// ────────────────────────────────────────────────────────────────────
...
// Maps zone soil types to display color (for tuinkaart bodem-overlay)
...
// Maps sun exposure to overlay color (for tuinkaart zon-overlay)
export const sunOverlayColor = {
  full:    "rgba(216, 146, 22, 0.45)",  // amber
  partial: "rgba(168, 200, 216, 0.40)", // sky
  shade:   "rgba(31, 48, 38, 0.35)",    // moss-900
} as const;

// Maps plant status to ring color (for zone-canvas plant status-ring)
...
// Maps month number to short Dutch label
